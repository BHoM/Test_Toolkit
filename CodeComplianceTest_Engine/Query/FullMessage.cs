...
namespace BH.Engine.Test.CodeCompliance
{
    public static partial class Query
    {
        ...
        public static string FullMessage(this Error error, int maxDepth = 3, TestStatus minSeverity = TestStatus.Pass)
        {
            ...
            return $"{error.Message} - For more information see {Base.Query.DocumentationURL("DevOps/Code%20Compliance%20and%20CI/Compliance%20Checks/")}{error.DocumentationLink}{Environment.NewLine}{Environment.NewLine}";
        }
