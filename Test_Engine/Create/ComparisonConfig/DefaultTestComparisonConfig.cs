...
namespace BH.Engine.Test
{
    public static partial class Create
    {
        ...
        [Description("Creates a default comparison config to be used for testing. Numeric tolerance set to 1e-12 and BHoM_Guid added to the properties to be ignored.")]
